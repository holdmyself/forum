					...
					<th style="width:20%" rowspan="2" class="r_two">
						...
						<div class="user-pic">
							<table style="border:0">
								<tr>
									<td width="1">
										<a href="<html:rewrite action="person.do?action=view" />&person.id=${ thread.author.id }"
											target="_blank" style="cursor:pointer;"><img class="pic"
												src="images/yellow/user.jpg"
							...
							<table style="border:0">
								<tr>
									<td width="1">
										...
										<a href="<html:rewrite action="/reply?action=initAdd" />&thread.id=${ thread.id }"
											target="_blank" style="cursor:pointer;"><img class="pic"
												src="images/yellow/user.jpg"
												width="100" height="100" border="0" /> </a>
									</td>
